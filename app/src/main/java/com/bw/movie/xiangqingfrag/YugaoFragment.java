...
import com.bw.movie.adapt.YugaoAdapter;
...
public class YugaoFragment extends BaseFragment implements IHomeContract.Iview {
    ...
    protected int getlayout() {
        return R.layout.activity_yugao_fragment;
    }
    ...
    public void onHomeGetXiangqingSuccess(XiangqingBean data) {
        List<XiangqingBean.ResultBean.ShortFilmListBean> shortFilmList = data.getResult().getShortFilmList();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        yugao.setLayoutManager(linearLayoutManager);
        YugaoAdapter yugaoAdapter = new YugaoAdapter(getActivity(), shortFilmList);
        yugao.setAdapter(yugaoAdapter);
    }
