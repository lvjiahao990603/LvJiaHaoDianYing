...
import com.bw.movie.adapt.YingpingAdapter;
...
public class YingpingFragment extends BaseFragment implements IHomeContract.Iview {


    @BindView(R.id.recy_yingping)
    RecyclerView recyYingping;
    ...
    protected void initData() {
        ...
        homePresenter.getYingpingPresenter(movieId,"1","10");
    }
    ...
    protected int getlayout() {
        return R.layout.activity_yingping_fragment;
    }
