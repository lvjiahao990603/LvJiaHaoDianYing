...
public class XQXieYingPingActivity extends BaseActivity implements IHomeContract.Iview {
    ...
    Button btYpPush;
    public static final String TAG="XQXieYingPingActivity";
    ...
    protected void initData() {
        ...
        homePresenter.getXieyingpingPresenter(movieId,"1","1");
    ...
    protected int getlayout() {
        return R.layout.activity_xqxie_ying_ping;
    }
    ...
    public void onHomeGetXieyingpingSuccess(XieyingpingBean data) {
        Log.d(TAG, "onXieYingPianPingLunSuccess: "+data);
    ...
    public void onHomeGetXieyingpingFailure(String e) {
        Toast.makeText(this, "已评论，无法重复评论", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_yp_push:
                String trim = etYpMovie.getText().toString().trim();
