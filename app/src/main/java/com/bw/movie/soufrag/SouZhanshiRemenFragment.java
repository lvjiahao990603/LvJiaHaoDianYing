...
import com.bw.movie.adapt.SouZhanshiRemenFragmentAdapter;
...
public class SouZhanshiRemenFragment extends BaseFragment implements IHomeContract.Iview {

    @BindView(R.id.recy_SouZhanshiRemenFragment)
    RecyclerView recySouZhanshiRemenFragment;
    ...
    protected void initData() {
        ...
        homePresenter.getRemenPresenter("1", "30");
    }
    ...
    protected int getlayout() {
        return R.layout.activity_sou_zhanshi_remen_fragment;
    }
    ...
    public void onHomeRemenSuccess(RemenBean data) {
        final List<RemenBean.ResultBean> result = data.getResult();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        recySouZhanshiRemenFragment.setLayoutManager(linearLayoutManager);
        SouZhanshiRemenFragmentAdapter souZhanshiRemenFragmentAdapter = new SouZhanshiRemenFragmentAdapter(getActivity(), result);
        recySouZhanshiRemenFragment.setAdapter(souZhanshiRemenFragmentAdapter);
        souZhanshiRemenFragmentAdapter.setOnItemClickListener(new SouZhanshiRemenFragmentAdapter.OnItemClickListener() {
            @Override
