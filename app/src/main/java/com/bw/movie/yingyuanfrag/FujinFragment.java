...
import com.bw.movie.adapt.FujinAdapter;
...
public class FujinFragment extends BaseFragment implements IHomeContract.Iview {


    @BindView(R.id.recy_fujin)
    RecyclerView recyFujin;
    ...
    protected void initData() {
        ...
        homePresenter.getFujinPresenter("13880", "157570326450013880","37.421998333333335","-122.08400000000002","1","20");
    }
    ...
    protected int getlayout() {
        return R.layout.activity_fujin;
    }
    ...
    public void onHomeGetFujinSuccess(FujinBean data) {
        List<FujinBean.ResultBean> result = data.getResult();
        linearLayoutManager = new LinearLayoutManager(getActivity());
        recyFujin.setLayoutManager(linearLayoutManager);
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        FujinAdapter fujinAdapter = new FujinAdapter(getActivity(), result);
        recyFujin.setAdapter(fujinAdapter);
        fujinAdapter.setOnItemClickListener(new FujinAdapter.OnItemClickListener() {
            @Override
