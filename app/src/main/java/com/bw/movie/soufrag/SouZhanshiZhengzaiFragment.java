...
import com.bw.movie.adapt.SouZhanshiZhengzaiFragmentAdapter;
...
public class SouZhanshiZhengzaiFragment extends BaseFragment implements IHomeContract.Iview {


    @BindView(R.id.recy_SouZhanshiZhengzaiFragmentAdapter)
    RecyclerView recySouZhanshiZhengzaiFragmentAdapter;
    ...
    protected int getlayout() {
        return R.layout.activity_sou_zhanshi_zhengzai_fragment;
    }
    ...
    public void onHomeZhengzaiSuccess(ZhengzaiBean data) {
        final List<ZhengzaiBean.ResultBean> result = data.getResult();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        recySouZhanshiZhengzaiFragmentAdapter.setLayoutManager(linearLayoutManager);
        SouZhanshiZhengzaiFragmentAdapter souZhanshiZhengzaiFragmentAdapter = new SouZhanshiZhengzaiFragmentAdapter(getActivity(), result);
        recySouZhanshiZhengzaiFragmentAdapter.setAdapter(souZhanshiZhengzaiFragmentAdapter);
        souZhanshiZhengzaiFragmentAdapter.setOnItemClickListener(new SouZhanshiZhengzaiFragmentAdapter.OnItemClickListener() {
            @Override
